from beta_schedule import linear_beta_schedule, cosine_beta_schedule
...
class GaussianDiffusion:
    ...
    # computep_mean_variance predicted mean and variance of p(x_{t-1} | x_t)
    ...
    @torch.no_grad()
    def fast_sample(self, model, image_size, batch_size=8, channels=3,
                    timestep_respacing="50", clip_denoised=True):
    ...
    def train_losses(self, model, x_start, t):
        ...
        model_mean, _, model_log_variance = self.p_mean_variance(
            lambda *args, r=frozen_output: r,  # use a simple lambda 返回固定值的函数
            x_noisy,
            t,
            clip_denoised=False
        )
